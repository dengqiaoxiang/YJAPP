        ...
        <wxc-popup popup-color="#eee"
            ...
            <div class="resultBox">
                ...
                <div class="resultList">
                    <wxc-cell label="会员名" :title="member.UserName">
                    </wxc-cell>
                    <wxc-cell label="公司名称" :title="member.Company">
                    </wxc-cell>
                    <wxc-cell label="地址" :title="member.Address">
                    </wxc-cell>
                    <wxc-cell label="联系人" :title="member.RealName">
                    </wxc-cell>
                    <wxc-cell label="电话" :title="member.Phone">
                    </wxc-cell>
                </div>
            </div>
                    
            <div class="button">
                <wxc-button text="查看详情" @wxcButtonClicked="toDetail" class="btnsub"></wxc-button>
            </div>
        </wxc-popup>
    </div>
</template>
	...
	export default {
	    ...
	    methods : {
            ...
            async getSearchRes (params) {
                ...
                const RES = await API.YJ_GetWebMemberInfo(params);
                if(RES.Success) {
