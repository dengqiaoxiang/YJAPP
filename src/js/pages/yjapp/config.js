    ...
    distribution: [{
            ...
            pages: [{
                ...
                },
                {
                    title: '收货订单',
                    isOther: false,
                    icon: 'http://yj.kiy.cn/Content/Images/App/assets/icon/fenzutongji.png',
                    name: 'deliverGoods'
                },
                {
                    title: '代客下单',
                    isOther: false,
                    icon: 'http://yj.kiy.cn/Content/Images/App/assets/icon/chongzhiliuliang.png',
                    name: 'customerOrder'
                },
                {
                    title: '会员查询',
                    isOther: false,
                    icon: 'http://yj.kiy.cn/Content/Images/App/assets/icon/会员统计.png',
                    name: 'searchMember'
                },
                {
                    title: '区域统计',
                    isOther: false,
                    icon: 'http://yj.kiy.cn/Content/Images/App/assets/icon/订单统计.png',
                    name: 'regionSummary'
                }
            ]
        }
