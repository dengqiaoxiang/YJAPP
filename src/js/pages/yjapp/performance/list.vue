    ...
    <div class="win">
        <div class="page">
            ...
            <scroller scroll-direction="horizontal"
                      class="table"
                      :style="{height: `${deviceHeight}px`,width: !isDeliver ? '1760px':'1370px'}">

                <div class="table-cell" :style="{width: !isDeliver ? '1760px':'1370px'}">
                    ...
                    <template v-if="!isDeliver">
                        <div class="table-td table-head width-200px"><text class="table-text">成本</text></div>
                        <div class="table-td table-head width-200px"><text class="table-text">毛利</text></div>
                    </template>
                ...
                <div class="table-cell" :style="{width: !isDeliver ? '1760px':'1370px'}">
                    ...
                    <template v-if="!isDeliver">
                        <div class="table-td table-bottom width-200px"><text class="table-text">{{intCostPrice}}</text></div>
                        <div class="table-td table-bottom width-200px"><text class="table-text">{{intProfitPrice}}</text></div>
                    </template>
                ...
                <list class="bui-list"
                    ...
                    <cell class="table-cell"
                          ...
                          @click="toDetail(item)"
                          :key="key"
                          :style="{width: !isDeliver ? '1760px':'1370px'}">
                        ...
                        <template v-if="!isDeliver">
                            <div class="table-td width-200px"><text class="table-text">{{item.CostPrice}}</text></div>
                            <div class="table-td width-200px"><text class="table-text">{{item.ProfitPrice}}</text></div>
                        </template>
        ...
        async getData(onrefreshState) {
            ...
            if (DGDATA.length != 0) {
                ...
                DGDATA.map(item => {
                    ...
                    this.intCostPrice = accAdd(
                        this.intCostPrice,
                        item.CostPrice
                    );
                    this.intProfitPrice = accAdd(
                        this.intProfitPrice,
                        item.ProfitPrice
                    );
                ...
                this.intCostPrice = this.intCostPrice.toFixed(2);
                this.intProfitPrice = this.intProfitPrice.toFixed(2);
