    ...
    <div>
        ...
        <scroller scroll-direction="horizontal"
            ...
            <div class="table-cell">
                ...
                <div class="table-td table-head width-150px"><text class="table-text">会员号</text></div>
                ...
                <div class="table-td table-head width-150px"><text class="table-text">运费</text></div>
                <div class="table-td table-head width-150px"><text class="table-text">折扣</text></div>
                <div class="table-td table-head width-150px"><text class="table-text">订单状态</text></div>
            </div>
            <list class="bui-list"
                  ref="list"
                  loadmoreoffset="2">
                <cell class="table-cell"
                    ...
                    <div class="table-td width-150px"><text class="table-text">{{item.UserId}}</text></div>
                    <div class="table-td width-200px"><text class="table-text two-line">{{item.ProductName}}</text></div>
                    <div class="table-td width-200px"><text class="table-text">{{item.ProductTotalAmount}}</text></div>
                    <div class="table-td width-150px"><text class="table-text">{{item.Freight}}</text></div>
                    <div class="table-td width-150px"><text class="table-text">{{item.OnlinePaymentDiscounts}}</text></div>
                    <div class="table-td width-150px"><text class="table-text">{{item.strOrderStatus}}</text></div>
                </cell>
            </list>
